...
def tty(mocker) -> None:
    ...
    mocker.patch("{{ cookiecutter.package_name }}.logging.sys.stdout.isatty", return_value=True)
    mocker.patch("{{ cookiecutter.package_name }}.logging.sys.stderr.isatty", return_value=True)
